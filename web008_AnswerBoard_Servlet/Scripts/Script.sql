...
INSERT INTO ANSWERBOARD a (SEQ, ID, TITLE, 
							CONTENT, "REF", STEP,
							"DEPTH")
		VALUES((SELECT NVL(MAX(SEQ),0) FROM ANSWERBOARD a )+1, 'A001', '답글 new',
				'글 내용 작성', (SELECT "REF" FROM ANSWERBOARD a2 WHERE SEQ='7'), (SELECT STEP FROM ANSWERBOARD a3 WHERE SEQ='7')+1,
				(SELECT "DEPTH" FROM ANSWERBOARD a4 WHERE SEQ='7')+1);

--답글 입력(update)
UPDATE ANSWERBOARD SET STEP=STEP+1
	WHERE REF=(SELECT REF FROM ANSWERBOARD a WHERE SEQ='7')
		AND STEP>(SELECT STEP FROM ANSWERBOARD a2 WHERE SEQ='7');
...
INSERT INTO ANSWERBOARD a (SEQ, ID, TITLE, 
							CONTENT, "REF", STEP,
							"DEPTH")
		VALUES(ANSWERBOARD_SEQ.NEXTVAL, 'A001', 'ROOT글 작성',
				'새 글 작성', (SELECT NVL(MAX(REF),0)+1 FROM ANSWERBOARD a2 )+1, 0,
				0);
INSERT INTO ANSWERBOARD a (SEQ, ID, TITLE, 
							CONTENT, "REF", STEP,
							"DEPTH")
		VALUES((SELECT NVL(MAX(SEQ),0) FROM ANSWERBOARD a )+1, 'A001', 'ROOT글 작성',
				'새 글 작성', (SELECT NVL(MAX(REF),0) FROM ANSWERBOARD a2 )+1, 0,
				0);
...
INSERT INTO ANSWERBOARD a (SEQ, ID, TITLE, 
							CONTENT, "REF", STEP,
							"DEPTH")
		VALUES((SELECT NVL(MAX(SEQ),0) FROM ANSWERBOARD a )+1, 'A999', 'REPLAY INSERT',
				'글 내용 작성', (SELECT "REF" FROM ANSWERBOARD a2 WHERE SEQ='4'), (SELECT STEP FROM ANSWERBOARD a3 WHERE SEQ='7')+1,
				(SELECT "DEPTH" FROM ANSWERBOARD a4 WHERE SEQ='4')+1);

-- 회원등록
INSERT INTO USERINFO
		(ID, NAME, PASSWORD, EMAIL, AUTH, DELFLAG, JOINDATE)
		VALUES('user', '사용자', '1234', 'user@gmail.com', 'U', 'N', SYSDATE);
INSERT INTO USERINFO
		(ID, NAME, PASSWORD, EMAIL, AUTH, DELFLAG, JOINDATE)
		VALUES('hello', '사용자', '1234', 'hello@gmail.com', 'U', 'N', SYSDATE);	
INSERT INTO USERINFO
		(ID, NAME, PASSWORD, EMAIL, AUTH, DELFLAG, JOINDATE)
...
SELECT SEQ, ID, LPAD(' ', DEPTH*10) || TITLE, "REF", STEP, "DEPTH", REGDATE, DELFLAG
	FROM ANSWERBOARD
	ORDER BY REF DESC, STEP ASC;
...
INSERT INTO ANSWERBOARD(SEQ, ID, TITLE, CONTENT, "REF", STEP, "DEPTH", REGDATE, DELFLAG)
	VALUES(ANSWERBOARD_SEQ.NEXTVAL, 'A001', 'root글 첫 번째', '임정운 바보', '1', '0', '0', '2020-10-06', 'N');
