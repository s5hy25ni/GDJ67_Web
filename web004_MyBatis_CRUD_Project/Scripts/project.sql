...
CREATE TABLE STADIUM AS (
	(SELECT STADIUM_ID , s.STADIUM_NAME AS STADIUM_NAME , HOMETEAM_ID AS TEAM_ID , SEAT_COUNT , t.ZIP_CODE1 AS ZIP_CODE1 , t.ZIP_CODE2 AS ZIP_CODE2 , t.ADDRESS AS ADDRESS , t.DDD AS DDD , t.TEL AS TEL , t.FAX AS FAX 
